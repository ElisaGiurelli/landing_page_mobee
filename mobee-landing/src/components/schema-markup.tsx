export function OrganizationSchema() {
  const organizationSchema = {
    ...
    "description": "Prima piattaforma AI certificata in Italia per la gestione talenti aziendali. Valutazione competenze, sviluppo carriera e analytics HR con intelligenza artificiale.",
    "url": "https://moobee.it",
    ...
    "knowsLanguage": ["it", "en"],
    "sameAs": [
      "https://www.linkedin.com/company/moobee-ai"
    ],
    "contactPoint": {
      "@type": "ContactPoint",
...
export function SoftwareApplicationSchema() {
  const softwareSchema = {
    ...
    "description": "Piattaforma AI per la gestione talenti aziendali con valutazione competenze, sviluppo carriera e analytics HR.",
    "url": "https://moobee.it",
...
export function WebSiteSchema() {
  const websiteSchema = {
    ...
    "url": "https://moobee.it",
    "description": "Prima piattaforma AI certificata in Italia per la gestione talenti aziendali",
    "publisher": {
      "@type": "Organization",
      "name": "MOOBEE"
    },
